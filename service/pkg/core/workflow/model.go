...
type NodeTemplateUpdateReq struct {
...
const (
	...
	FetchToolTemplate   ActionType = "fetch_tool_template"
...
type DeviceReq struct {
	LabUUID uuid.UUID `form:"lab_uuid" json:"lab_uuid" uri:"lab_uuid" binding:"required"`
}
...
type DevicesResp struct {
	...
	DeviceTemplates map[uuid.UUID]*TplHandle `json:"device_templates"`
}
