...
type Service interface {
	...
	NodeTemplateUpdate(ctx context.Context, req *NodeTemplateUpdateReq) error
	...
	GetWorkflowGraph(ctx context.Context, workflowUUID uuid.UUID) (*WSGraph, error)
	LabDeviceList(ctx context.Context, req *DeviceReq) (*DevicesResp, error)
}
