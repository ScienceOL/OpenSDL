...
type TemplateResp struct {
	...
	ConfigInfos  datatypes.JSONSlice[model.ResourceConfig] `json:"config_infos,omitempty"`
	Pose         datatypes.JSONType[model.Pose]            `json:"pose"`
}
...
type ReagentInfo struct {
	ReagentUUID uuid.UUID `json:"uuid"`
...
type WSNode struct {
	...
	InitParamSchema   datatypes.JSON                 `json:"init_param_schema,omitempty"`
	Schema            datatypes.JSON                 `json:"schema,omitempty"`
	Data              datatypes.JSON                 `json:"data"`
	PlateWellDatas    map[string]datatypes.JSON      `json:"plate_well_datas"`
	PlateReagentDatas map[string]ReagentInfo         `json:"plate_reagent_datas"`
...
type DataParam struct {
	...
	ParamInputData datatypes.JSON `json:"param_input_data"`
