...
import (
	...
	// 内部引用
	"github.com/scienceol/opensdl/service/pkg/utils"
)
...
func (u Size) MarshalJSON() ([]byte, error) {
	type Alias Size
	return json.Marshal(Alias{
		Width:  utils.Or(u.Width, 200), // 0
		Height: utils.Or(u.Height, 200), // 0
		Depth:  utils.Or(u.Depth, 20), // 0
	})
}
...
func (u *Size) UnmarshalJSON(data []byte) error {
	...
	u.Width = utils.Or(u.Width, 200) // 0
	u.Height = utils.Or(u.Height, 200) // 0
	u.Depth = utils.Or(u.Depth, 20) // 0
	return nil
}
