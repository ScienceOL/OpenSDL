...
type Workflow struct {
	BaseModel
	UserID      string                      `gorm:"type:varchar(120);not null;index:idx_workflow_lpu,priority:3" json:"user_id"`
	LabID       int64                       `gorm:"type:bigint;not null;index:idx_workflow_lpu,priority:1" json:"lab_id"`
	ProjectID   int64                       `gorm:"bigint;not null;default:0;index:idx_workflow_lpu,priority:2" json:"project_id"`
...
const (
	...
	WorkflowToolCall  WorkflowNodeType = "tool_call"
)
...
// 样品对应结果
type WorkflowNodeJobSample struct {
	BaseModel
	JobID    int64             `gorm:"type:bigint;not null;index:idx_workflow_node_job_sample_j,priority:1" json:"job_id"`
	SampleID int64             `gorm:"type:bigint;not null;index:idx_workflow_node_job_sample_j,priority:2" json:"sample_id"`
	OssPath  string            `gorm:"type:text" json:"oss_path"`
	Extra    datatypes.JSONMap `gorm:"type:jsonb" json:"extra"`
}

func (*WorkflowNodeJobSample) TableName() string {
	return "workflow_node_job_sample"
}
...
type WorkflowTask struct {
	...
	NotebookGroupID int64              `gorm:"type:bigint;index:idx_workflowtask_ngid" json:"notebook_group_id"`
