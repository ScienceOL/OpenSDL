...
func (e ErrCodeWithMsg) Error() string {
	return e.String()
}
...
const (
	...
	DataExistErr                                      // data exist error
	DataNotFoundErr                                   // lab member not found err
)
...
const (
	...
	LabInnerRoleExist                                  // lab inner role exist
	LabInnerAdminRoleNoteExist                         // lab inner admin role not exist
	RoleNotExistErr                                    // role not exist error
	LabPolicyResourceNotExist                          // lab policy resource not exist error
	UnknownPermErr                                     // unknown perm error
	LabMemberNotFoundErr                               // not found lab member error
	PolicyResourceNotFoundErr                          // policy resource not found error
	NotLabMemberErr                                    // user not laboratory member
)
...
const (
	...
	NotebookNotExistErr                                    // notebook note exist error
	NotebookNotInitErr                                     // notebook not init status error
	NotebookParamEmptyErr                                  // notbook param enpty error
	NotebookParamCountErr                                  // notbook param count error
	NotebookChangeParamErr                                 // notebook change param error
...
const (
	OssClientCreateErr ErrCode = iota + 40000 // failed to create OSS client
	OssGetBucketErr                           // failed to get OSS bucket
	OssGetSignErr                             // failed to sign OSS URL
	OssTokenSaveErr                           // failed to save storage token to database
)

// reagent module errors
const (
	ReagentCreateErr       ErrCode = iota + 50000 // create reagent failed
	ReagentQueryErr                               // query reagent failed
	ReagentCASQueryErr                            // query reagent CAS failed
	ReagentCASNotFindErr                          // query reagent CAS failed
	ReagentConsumeErr                             // consume reagent failed
	ReagentNotFoundErr                            // reagent not found error
	ReagentInsufficientErr                        // reagent insufficient error
)
