...
type Server struct {
	...
	Port         int    `mapstructure:"WEB_PORT" default:"80"`
	SchedulePort int    `mapstructure:"SCHEDULE_PORT" default:"81"`
...
type RPC struct {
	...
	PubChem  PubChem  `mapstructure:",squash"`
	Opa      Opa      `mapstructure:",squash"`
}
...
type PubChem struct {
	Addr string `mapstructure:"PUBCHEM_ADDR" default:"https://pubchem.ncbi.nlm.nih.gov"`
}

type Opa struct {
	Addr string `mapstructure:"OPA_ADDR" default:"http://127.0.0.1:8181"`
}
...
type Inner struct {
	BasicAuthUser     string `mapstructure:"BASIC_AUTH_USER" default:"uni-lab"`
	BasicAuthPassword string `mapstructure:"BASIC_AUTH_PASSWORD" default:"uni-lab-inner"`
}
