...
func _() {
	...
	_ = x[NotebookSubmittedErr-30040]
}
...
const (
	...
	_ErrCode_name_3 = "database create data errordatabase update data errordatabase record not founddatabase query errordatabase delete errornot base db type errormodel not implement schema.Tablerredis lua script errorredis lua return type errorredis add user set errorredis remove user set errordata exist errorlab member not found err"
	_ErrCode_name_4 = "reg action name emptyresource is emptyresource not existcan not found workflow template erroruser id is emptylab id is empty errorlaboratory not found errorcan not found laboratory invite link errorinvite expired errorinvalidate third id errorlab already deleted errorlab inner role existlab inner admin role not existrole not exist errorlab policy resource not exist errorunknown perm errornot found lab member errorpolicy resource not found erroruser not laboratory member"
...
var (
	...
	_ErrCode_index_3 = [...]uint16{0, 26, 52, 77, 97, 118, 140, 173, 195, 222, 246, 273, 289, 313}
	_ErrCode_index_4 = [...]uint16{0, 21, 38, 56, 93, 109, 130, 156, 198, 218, 243, 268, 288, 318, 338, 373, 391, 417, 448, 474}
	...
	_ErrCode_index_9 = [...]uint16{0, 33, 59, 86, 124, 147, 165, 198, 224, 246, 280, 314, 348, 386, 427, 444, 467, 500, 515, 546, 581, 616, 651, 682, 715, 742, 769, 790, 824, 849, 878, 905, 937, 963, 982, 1007, 1037, 1062, 1087, 1114, 1136, 1161}
)
